...
| ------- | ---------------------- | ------------------------- | ------------------------------------- |
| Abort   | [`abort.md`](abort.md) | [`src/core`](../src/core) | [`tests/src/core`](../tests/src/core) |

## By directory

| Directory  | Guide                  |
| ---------- | ---------------------- |
| `src/core` | [`abort.md`](abort.md) |
...
- [`AGENTS.md`](../AGENTS.md) — the pointer to the `@orkestrel/scaffold` coding contract, whose documentation rules this index answers to.
